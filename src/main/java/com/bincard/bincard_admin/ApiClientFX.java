...
public class ApiClientFX {
    ...
    public static LoginResponse login(String telephone, String password) throws IOException {
        URL url = new URL(BASE_URL + "/auth/admin-login");
    ...
    public static TokenResponse phoneVerify(String telephone, String verificationCode) throws IOException {
        ...
        String jsonInput = String.format(
                "{\"telephone\":\"%s\",\"code\":\"%s\",\"ipAddress\":\"%s\",\"deviceInfo\":\"%s\",\"appVersion\":\"1.0\",\"platform\":\"DESKTOP\"}",
                telephone, verificationCode, getPublicIpAddress(), "Desktop-Admin-Panel"
        );
            ...
            if (code == 200) {
                try {
                    ...
                    TokenDTO accessTokenDTO = new TokenDTO(
                            ...
                            accessIssuedAt, 
                            accessExpiresAt, 
                            accessIssuedAt, // lastUsedAt başlangıçta issuedAt ile aynı
                            accessIpAddress, 
                            accessDeviceInfo, 
                            TokenType.ACCESS
                    );
                    ...
                    TokenDTO refreshTokenDTO = new TokenDTO(
                            ...
                            refreshIssuedAt, 
                            refreshExpiresAt, 
                            refreshIssuedAt, // lastUsedAt başlangıçta issuedAt ile aynı
                            refreshIpAddress, 
                            refreshDeviceInfo, 
                            TokenType.REFRESH
                    );
                ...
                throw new IOException("Phone verification failed: " + code + " - " + resp);
            }
        }
    }
    ...
    public static String signup(
        ...
        URL url = new URL(BASE_URL + "/admin/sign-up");
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
        conn.setRequestProperty("Content-Type", "application/json");
        conn.setDoOutput(true);
        ...
        String jsonInput = String.format(
                "{" +
                    ...
                    "\"userAgent\":\"%s\"" +
                "}",
                name, surname, telephone, password, email, ipAddress, deviceUuid, userAgent
        );
        ...
        try (BufferedReader br = new BufferedReader(
            ...
            if (code == 200) {
                ...
                throw new IOException("Signup failed: " + code + " - " + response.toString());
            }
        }
    }
