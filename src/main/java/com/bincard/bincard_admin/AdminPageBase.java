...
public abstract class AdminPageBase {
    ...
    private void createBasicUI() {
        ...
        stage.setTitle(pageTitle + " - Bincard Admin");
    ...
    protected HBox createHeader() {
        ...
        Label userInfo = new Label("Admin");
        userInfo.setFont(Font.font("Segoe UI", FontWeight.NORMAL, 16));
    ...
    protected HBox createFooter() {
        ...
        Label footerText = new Label("© 2025 Bincard Admin Panel | Tüm Hakları Saklıdır");
